  ...
  return (
    <div className="Tictactoe">
      ...
      <div className="TictactoeContent">
        ...
        <a href="https://mortenemde.github.io/tic-tac-toe/ticTacToe.html" target="_blank" rel="noopener noreferrer"><img className="TictactoeImage" src={process.env.PUBLIC_URL + '/Images/tictactoeLogo.png'} alt="tictactoeImage" /></a>
      </div>
    </div>
  );
}
