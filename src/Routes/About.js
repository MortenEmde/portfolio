  ...
  return (
    <div className="About">
      ...
      <div className="AboutContent">
        ...
        <p>
          In my spare time, I enjoy playing videogames, bordgames, going to the cinema or a great consert. And last but not least, I enjoy learning new ways to improve my code. 
        </p>
        <p>
