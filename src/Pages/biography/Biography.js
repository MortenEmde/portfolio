...
const paragraphs = [
  ...
  ["My name, as it says in the top, is Morten Emde Christensen and I’m a 30-year-old jack-of-all-trades. A little more than a decade ago, I started my career as an electrician, working on simple garden variety (or, as they say in Dutch, ‘huis-tuin-en-keuken’) jobs and far bigger projects such as Vestas’ wind turbines. My first taste of the world of programming was during my electrician’s degree, where I had to work with Intelligent House Control (IHC) to make programmable lighting, ventilation and alarm-systems. My interest was piqued and shelved for a later moment in my life."],
