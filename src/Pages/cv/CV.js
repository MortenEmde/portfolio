      ...
      <div className="CVContent">
        <div className="Experience">
          ...
          <div className="Education">
            ...
            <ul className="EducationDescription">
              <li className="EducationTask">
                Graduation assignment -  Designing and building a complete Intelligent House Control (IHC) Including:
              </li>
          ...
          <div className="Job">
            ...
            <h5 className="JobDuration">
              Various companies / Denmark, Spain, United Kingdom / August 2006 – March 2011
            </h5>
            <ul className="JobDescription">
              <li className="JobTask">
        ...
        <div className="Skills">
          ...
          <ul className="CertificateList">
            <li className="Certificate">
              &lt;/Salt&gt; Fullstack JavaScript - 2020
            </li>
            <li className="Certificate">
